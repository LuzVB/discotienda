...
public class DatosCancion extends Datos implements Serializable {
    ...
    public void listarCancionU() throws SQLException {
        ...
        try {
            String sql = "SELECT id_cancion, id_album,nombre_artista, nombre_album, nombre_cancion, duracion_cancion, formato_album, precio_cancion  FROM public.view_listacancion";
            ...
            while (result.next()) {
                ...
                int id = Integer.parseInt(result.getString("id_cancion"));
                int idPrecio = Integer.parseInt(result.getString("precio_cancion"));
                int idAlbum = Integer.parseInt(result.getString("id_album"));
                listaCancionU.add(new Usuario(id, result.getString("nombre_artista"),
                        result.getString("nombre_album"), result.getString("nombre_cancion"),
                        result.getString("duracion_cancion"), result.getString("formato_album"), idPrecio, idAlbum));
